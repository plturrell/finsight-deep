...
class WorkflowBuilder(Builder, AbstractAsyncContextManager):
    ...
    @handle_errors(exceptions_to_catch=(ValueError, KeyError, AttributeError), reraise=True)
    def build(self, entry_function: str | None = None) -> Workflow:
        ...
        if (self._workflow is None):
            raise ConfigurationError("Must set a workflow before building")
        ...
        if (entry_function is None):
            ...
            try:
                ...
                raise ResourceNotFoundError(f"Entry function '{entry_function}' not found")
